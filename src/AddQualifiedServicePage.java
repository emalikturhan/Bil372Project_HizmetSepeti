...
public class AddQualifiedServicePage extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddQualifiedServicePage frame = new AddQualifiedServicePage();
     ...
     * Create the frame.
     */
    public AddQualifiedServicePage() {
        //setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);

        setSize(450,500);
        setLocation(500,200);

        setTitle("Add New Qualified Service");
        getContentPane().setLayout(null);

        ft = new Font("Verdana",Font.BOLD,16);


        // Header Title
        JLabel hRegister = new JLabel("Add New Qualified Service");
        hRegister.setFont(ft);
        hRegister.setForeground(new Color(0,170,50));

        hRegister.setHorizontalAlignment(SwingConstants.CENTER);
        hRegister.setBounds(85, 30, 250, 20);
        ...
        JLabel hDegree = new JLabel("Degree :");
        hDegree.setBounds(70, 208, 89, 14);
        hDegree.setForeground(new Color(0,100,100));
        getContentPane().add(hDegree);

        JLabel hInfo = new JLabel("Information :");
        hInfo.setBounds(70, 278, 89, 14);
        ...
        txtDegree= new JTextArea("");
        txtDegree.setBounds(215, 200, 176, 60);
        txtDegree.setLineWrap(true);
        txtDegree.setWrapStyleWord(true);
        txtDegree.setBorder( BorderFactory.createLineBorder(Color.GRAY));
        getContentPane().add(txtDegree);

        txtInfo= new JTextArea("");
        txtInfo.setBounds(215, 270, 176, 60);
        ...
        btnSave.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if(RegisterData()) {
                    ...
                    String insertQuery1 = "insert into qualified (service_id, degree) values ((select max(service.service_id) from service), ?)";
                    try {
                        ...
                        ps.setString(1, txtDegree.getText());
                        ps.executeUpdate();
                    } catch (Exception e) {
                        e.printStackTrace();
                    } finally {
