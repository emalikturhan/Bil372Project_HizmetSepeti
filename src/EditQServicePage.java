...
public class EditQServicePage extends JFrame {
    ...
    public EditQServicePage(String serviceID) {
        setSize(450,500);
        setLocation(500,200);
        ...
        String query = "select * from qualified, service where service.service_id = qualified.service_id AND qualified.service_id=" + serviceID;
        try {
        ...
        btnSave.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                if(RegisterData()) {
                    ...
                    String insertQuery2 = "UPDATE qualified set degree=? where service_id=" + serviceID;
                    try {
